...
export default async function AdminApplicationsPage({ params }: { params: Promise<{ podId: string }> }) {
  ...
  return (
    <main className="app-shell">
      <header className="app-topbar entrance entrance-topbar"><Link className="wordmark" href={`/pods/${podId}/admin`}><span className="pod-mark" aria-hidden="true"><i /><i /><i /></span>PODS</Link><span className="phase-pill">Review queue</span></header>
