...
export default function NotFoundPage() {
  return (
    <main className="app-shell not-found-shell">
      <header className="app-topbar"><Link className="wordmark" href="/"><span className="pod-mark" aria-hidden="true" />pods</Link><span className="phase-pill">Unavailable</span></header>
